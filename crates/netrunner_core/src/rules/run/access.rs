...
mod tests {
    ...
    fn card_with_on_accessed(id: &str, effects: Vec<Effect>) -> CardDefinition {
        CardDefinition {
            triggers: vec![TriggeredEffect { subject: Some(crate::dsl::Subject::This), text: None, trigger: Trigger::OnAccessed, effects, requirement: None }],
            trash_cost: None,
            ..trashable_card(id, 0)
        }
    }
    ...
    fn trashable_card_with_on_trashed_from_access(id: &str, trash_cost: u32, effects: Vec<Effect>) -> CardDefinition {
        CardDefinition {
            triggers: vec![TriggeredEffect { subject: Some(crate::dsl::Subject::This), text: None, trigger: Trigger::OnTrashedFromAccess, effects, requirement: None }],
    ...
    fn card_with_interactive_and_on_accessed(
        ...
        CardDefinition {
            ...
            triggers: vec![TriggeredEffect { subject: Some(crate::dsl::Subject::This), text: None, trigger: Trigger::OnAccessed, effects: on_accessed_effects, requirement: None }],
            trash_cost: None,
            ..trashable_card(id, 0)
        }
    }

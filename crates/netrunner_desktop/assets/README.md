...
| Avatar bar | `board/avatar.bar[.active].png` | 48 tall, half the board wide each wing (43 on the far side) | **480 × 96**, ends 160 each | nine-sliced, the right wing mirrored | bundled steel; drawn grey plate washed in the side's colour | [board/](board/README.md#the-avatar-bar) |
| Avatar ring | `board/avatar.frame[.active].png` | 72 square (65 on the far side) | **256 × 256** | stretched to the disc | bundled steel ring; drawn grey ring | [board/](board/README.md#the-avatar-bar) |

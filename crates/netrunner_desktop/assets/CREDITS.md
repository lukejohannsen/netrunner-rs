...
| `board/plate.archives.png` | Archives' nameplate frame, Corp blue with shelving etched, painted by code (`scripts/paint_tiles.py`) in the avatar bar's brushed steel and circuits | netrunner-rs contributors | https://github.com/lukejohannsen/netrunner-rs | GPL-3.0-or-later | the repository's `LICENSE` | project | none |
| `board/plate.archives.run.png` | Archives' nameplate frame under a run, the Runner's red, painted by code (`scripts/paint_tiles.py`) in the avatar bar's brushed steel and circuits | netrunner-rs contributors | https://github.com/lukejohannsen/netrunner-rs | GPL-3.0-or-later | the repository's `LICENSE` | project | none |
| `board/plate.hardware.png` | The rig's Hardware row nameplate frame, the Runner's red, painted by code (`scripts/paint_tiles.py`) in the avatar bar's brushed steel and circuits | netrunner-rs contributors | https://github.com/lukejohannsen/netrunner-rs | GPL-3.0-or-later | the repository's `LICENSE` | project | none |
| `board/plate.hq.png` | HQ's nameplate frame, Corp blue with office windows etched, painted by code (`scripts/paint_tiles.py`) in the avatar bar's brushed steel and circuits | netrunner-rs contributors | https://github.com/lukejohannsen/netrunner-rs | GPL-3.0-or-later | the repository's `LICENSE` | project | none |
| `board/plate.hq.run.png` | HQ's nameplate frame under a run, the Runner's red, painted by code (`scripts/paint_tiles.py`) in the avatar bar's brushed steel and circuits | netrunner-rs contributors | https://github.com/lukejohannsen/netrunner-rs | GPL-3.0-or-later | the repository's `LICENSE` | project | none |
| `board/plate.programs.png` | The rig's Programs row nameplate frame, the Runner's red, painted by code (`scripts/paint_tiles.py`) in the avatar bar's brushed steel and circuits | netrunner-rs contributors | https://github.com/lukejohannsen/netrunner-rs | GPL-3.0-or-later | the repository's `LICENSE` | project | none |
| `board/plate.remote.png` | A remote server's nameplate frame, Corp blue with rack slots etched, painted by code (`scripts/paint_tiles.py`) in the avatar bar's brushed steel and circuits | netrunner-rs contributors | https://github.com/lukejohannsen/netrunner-rs | GPL-3.0-or-later | the repository's `LICENSE` | project | none |
| `board/plate.remote.run.png` | A remote server's nameplate frame under a run, the Runner's red, painted by code (`scripts/paint_tiles.py`) in the avatar bar's brushed steel and circuits | netrunner-rs contributors | https://github.com/lukejohannsen/netrunner-rs | GPL-3.0-or-later | the repository's `LICENSE` | project | none |
| `board/plate.resources.png` | The rig's Resources row nameplate frame, the Runner's red, painted by code (`scripts/paint_tiles.py`) in the avatar bar's brushed steel and circuits | netrunner-rs contributors | https://github.com/lukejohannsen/netrunner-rs | GPL-3.0-or-later | the repository's `LICENSE` | project | none |
| `board/plate.rnd.png` | R&D's nameplate frame, Corp blue with data lines etched, painted by code (`scripts/paint_tiles.py`) in the avatar bar's brushed steel and circuits | netrunner-rs contributors | https://github.com/lukejohannsen/netrunner-rs | GPL-3.0-or-later | the repository's `LICENSE` | project | none |
| `board/plate.rnd.run.png` | R&D's nameplate frame under a run, the Runner's red, painted by code (`scripts/paint_tiles.py`) in the avatar bar's brushed steel and circuits | netrunner-rs contributors | https://github.com/lukejohannsen/netrunner-rs | GPL-3.0-or-later | the repository's `LICENSE` | project | none |

...
| `backdrops/menu.jpg` | *The Root*, card art (Upstalk), © Fantasy Flight Games, the copy jinteki.net ships at mtgred/netrunner `resources/public/img/bg/TheRoot.jpg`: the shared backdrop, behind every menu screen without a picture of its own | Alex Kim | https://www.artstation.com/alexkim | All rights reserved | — | third-party | none |

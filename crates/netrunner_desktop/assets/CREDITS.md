...
| `backdrops/new-game.jpg` | *Maya*, card art (Kala Ghoda), © Fantasy Flight Games, as FFG's 2016 *Treasures from the Net* wallpaper: the Play vs Computer backdrop | Adam Schumpert | https://adamschumpert.com | All rights reserved | — | third-party | none |
| `backdrops/cards.jpg` | *Dyson Mem Chip*, card art (Core Set), © Fantasy Flight Games & Wizards of the Coast, the copy jinteki.net ships at mtgred/netrunner `resources/public/img/bg/DysonMemChip.jpg`: the card browser's backdrop | JB Casacop | https://www.artstation.com/jbcasacop | All rights reserved | — | third-party | none |

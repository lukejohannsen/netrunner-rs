...
fn blank_card(id: String, side: Side, card_type: CardType) -> CardDefinition {
    CardDefinition {
        ...
        influence_limit: None, installs_on_ice: false, hosted_cards_playable_from_grip: false, ice_rez_cost_modifier: 0, dividends: None, playable_from_archives: false, click_breakable: false, strength_modifier: None, persistent_after_trash: false, unique: false, base_link: None, is_playable: true,
    }
}
